...
void FormWindowManager::setupActions()
{
   ...
   m_actionRaise->setShortcut(Qt::ControlModifier + Qt::Key_L);
   ...
   m_actionLower->setShortcut(Qt::ControlModifier + Qt::Key_K);
   ...
   m_actionAdjustSize->setShortcut(Qt::ControlModifier + Qt::Key_J);
   ...
   m_actionHorizontalLayout->setShortcut(Qt::ControlModifier + Qt::Key_1);
   ...
   m_actionVerticalLayout->setShortcut(Qt::ControlModifier + Qt::Key_2);
   ...
   m_actionFormLayout->setShortcut(Qt::ControlModifier + Qt::Key_6);
   ...
   m_actionGridLayout->setShortcut(Qt::ControlModifier + Qt::Key_5);
   ...
   m_actionSplitHorizontal->setShortcut(Qt::ControlModifier + Qt::Key_3);
   ...
   m_actionSplitVertical->setShortcut(Qt::ControlModifier + Qt::Key_4);
   ...
   m_actionBreakLayout->setShortcut(Qt::ControlModifier + Qt::Key_0);
