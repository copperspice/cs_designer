...
class QtGradientEditorPrivate
{
 public:
   ...
   void setSpinBox(QDoubleSpinBox *spinBox, const QString &slot, double max = 1.0, double step = 0.01, int decimals = 3);
   void reset();
...
void QtGradientEditorPrivate::setSpinBox(QDoubleSpinBox *spinBox, const QString &slot, double max, double step, int decimals)
{
...
void QtGradientEditorPrivate::slotGradientStopsChanged(const QVector<QPair<qreal, QColor>> &stops)
{
   ...
   : QWidget(parent), d_ptr(new QtGradientEditorPrivate())
{
   ...
   connect(d_ptr->m_ui.detailsButton, SIGNAL(clicked(bool)),
         this, SLOT(slotDetailsChanged(bool)));

   connect(d_ptr->m_gradientStopsController, &QtGradientStopsController::gradientStopsChanged,
         this, &QtGradientEditor::slotGradientStopsChanged);

   QIcon iconLinear(":/resources/gradient_editor/images/typelinear.png");
   QIcon iconRadial(":/resources/gradient_editor/images/typeradial.png");
   QIcon iconConical(":/resources/gradient_editor/images/typeconical.png");
   ...
   QIcon iconPad(":/resources/gradient_editor/images/spreadpad.png");
   QIcon iconRepeat(":/resources/gradient_editor/images/spreadrepeat.png");
   QIcon iconReflect(":/resources/gradient_editor/images/spreadreflect.png");
...
void QtGradientEditor::slotGradientStopsChanged(const QVector<QPair<qreal, QColor>> &stops)
{
   Q_D(QtGradientEditor);
   d->slotGradientStopsChanged(stops);
}

void QtGradientEditor::slotTypeChanged(int type)
{
   Q_D(QtGradientEditor);
   d->slotTypeChanged(type);
}

void QtGradientEditor::slotSpreadChanged(int type)
{
   Q_D(QtGradientEditor);
   d->slotSpreadChanged(type);
}

void QtGradientEditor::slotStartLinearXChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotStartLinearXChanged(value);
}

void QtGradientEditor::slotStartLinearYChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotStartLinearYChanged(value);
}

void QtGradientEditor::slotEndLinearXChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotEndLinearXChanged(value);
}

void QtGradientEditor::slotEndLinearYChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotEndLinearYChanged(value);
}

void QtGradientEditor::slotCentralRadialXChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotCentralRadialXChanged(value);
}

void QtGradientEditor::slotCentralRadialYChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotCentralRadialYChanged(value);
}

void QtGradientEditor::slotFocalRadialXChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotFocalRadialXChanged(value);
}

void QtGradientEditor::slotFocalRadialYChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotFocalRadialYChanged(value);
}

void QtGradientEditor::slotRadiusRadialChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotRadiusRadialChanged(value);
}

void QtGradientEditor::slotCentralConicalXChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotCentralConicalXChanged(value);
}

void QtGradientEditor::slotCentralConicalYChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotCentralConicalYChanged(value);
}

void QtGradientEditor::slotAngleConicalChanged(double value)
{
   Q_D(QtGradientEditor);
   d->slotAngleConicalChanged(value);
}

void QtGradientEditor::slotDetailsChanged(bool details)
{
   Q_D(QtGradientEditor);
   d->slotDetailsChanged(details);
}

void QtGradientEditor::startLinearChanged(const QPointF &un_named_arg1)
{
   Q_D(QtGradientEditor);
   d->startLinearChanged(un_named_arg1);
}

void QtGradientEditor::endLinearChanged(const QPointF &un_named_arg1)
{
   Q_D(QtGradientEditor);
   d->endLinearChanged(un_named_arg1);
}

void QtGradientEditor::centralRadialChanged(const QPointF &un_named_arg1)
{
   Q_D(QtGradientEditor);
   d->centralRadialChanged(un_named_arg1);
}

void QtGradientEditor::focalRadialChanged(const QPointF &un_named_arg1)
{
   Q_D(QtGradientEditor);
   d->focalRadialChanged(un_named_arg1);
}

void QtGradientEditor::radiusRadialChanged(qreal un_named_arg1)
{
   Q_D(QtGradientEditor);
   d->radiusRadialChanged(un_named_arg1);
}

void QtGradientEditor::centralConicalChanged(const QPointF &un_named_arg1)
{
   Q_D(QtGradientEditor);
   d->centralConicalChanged(un_named_arg1);
}

void QtGradientEditor::angleConicalChanged(qreal un_named_arg1)
{
   Q_D(QtGradientEditor);
   d->angleConicalChanged(un_named_arg1);
}