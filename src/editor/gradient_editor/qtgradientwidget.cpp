...
class QtGradientWidgetPrivate
{
 public:
   ...
   QVector<QPair<qreal, QColor>> m_gradientStops;
...
void QtGradientWidget::setGradientStops(const QVector<QPair<qreal, QColor>> &stops)
{
   d_ptr->m_gradientStops = stops;
   update();
}

QVector<QPair<qreal, QColor>> QtGradientWidget::gradientStops() const
{
