...
static inline QDebug operator<<(QDebug str, const QFormLayout &fl)
{
   return debugGridLikeLayout(str, fl);
}
...
int LayoutProperties::toPropertySheet(const QDesignerFormEditorInterface *core, QLayout *l, int mask, bool applyChanged) const
{
   ...
   // sizeConstraint
   variantPropertyToSheet(mask, SizeConstraintProperty, applyChanged, sheet, sizeConstraintC, m_sizeConstraint, m_sizeConstraintChanged,
      &rc);
   ...
   variantPropertyToSheet(mask, GridColumnStretchProperty, applyChanged, sheet, gridColumnStretchPropertyC, m_gridColumnStretch,
      m_gridColumnStretchChanged, &rc);
   variantPropertyToSheet(mask, GridRowMinimumHeightProperty, applyChanged, sheet, gridRowMinimumHeightPropertyC, m_gridRowMinimumHeight,
      m_gridRowMinimumHeightChanged, &rc);
...
QBoxLayoutSupport::QBoxLayoutSupport(QDesignerFormWindowInterface *formWindow, QWidget *widget, Qt::Orientation orientation,
   QObject *parent) :
