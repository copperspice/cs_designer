...
static const QString KEY_SNAPX    = "gridSnapX";
static const QString KEY_SNAPY    = "gridSnapY";
static const QString KEY_DELTAX   = "gridDeltaX";
static const QString KEY_DELTAY   = "gridDeltaY";
...
{
   const auto iter  = v.constFind(key);
   const bool found = (iter != v.constEnd());

   if (found) {
      value = iter.value().value<T>();
   }
