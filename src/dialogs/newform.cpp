...
QDialogButtonBox *NewForm::createButtonBox()
{
   ...
   buttonBox->addButton(QApplication::translate("NewForm", "&Close", 0), QDialogButtonBox::RejectRole);

   buttonBox->addButton(m_createButton, QDialogButtonBox::AcceptRole);
   buttonBox->addButton(QApplication::translate("NewForm", "&Open...", 0), QDialogButtonBox::ActionRole);
